...
class _QRViewState extends State<QRView> {
  ...
  Widget _getPlatformQrViewWithOverlay() {
    var tipMargin = MediaQuery.of(context).size.width / 6 + 10;
    var stream = controller?.scanErrorStream.asBroadcastStream();
    return Stack(
      ...
      children: [
        ...
        StreamBuilder<bool>(
            ...
            builder: (context, asy) {
              return Visibility(
                child: Positioned(
                  child: widget.bottomTip ?? Container(),
                  top: (MediaQuery.of(context).size.height / 2) +
                      widget.overlay!.cutOutHeight / 2 +
                      15,
                  left: tipMargin,
                  right: tipMargin,
                ),
...
class QRViewController {
  ...
  final StreamController<bool> _scanErrorUpdateController =
      StreamController<bool>();

  Stream<bool> get scanErrorStream => _scanErrorUpdateController.stream;

  StreamController<bool> get scanErrorController => _scanErrorUpdateController;
  ...
  void dispose() {
    ...
    _scanErrorUpdateController.close();
  }
